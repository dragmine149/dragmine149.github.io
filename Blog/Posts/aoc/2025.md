...
#### for fun
Deided to run part 1 againts part 2 code, it's the same just with a different vector length. Same answer, just slightly worse time. Which makes sense, part 1 only required 1 loop instead of 2 but its nice to know that unlike day 2 my part 2 code works
for part 1 as well.
