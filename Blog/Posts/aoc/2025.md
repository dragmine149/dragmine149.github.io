...
Comming back from breakfast and relooking at it. (especially the debug output of the ranges), multiple iterations of merging all the ranges where required as some merges would open new possibilites. SO shoving my code in a function, looping whilst the
