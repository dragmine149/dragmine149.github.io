...
KDE has made customization very easy, whilst some of the default applications provided has improved aspects over windows (the file explorer here is way better than on windows).
...
The first year, where the whole story aspect is random and nothing is standardize. Kinda made it felt like it was designed as a test project and not something that was going to keep going for 10 years.
